...
<div class="topbar">
    <div class="topbar-left">
        <!-- Sidebar Toggle -->
        <button class="sidebar-toggle" id="sidebarToggle" data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    <div class="topbar-right">
        ...
        <!-- Notifications -->
        <div class="dropdown">
            <button class="notification-btn" data-bs-toggle="dropdown" data-bs-toggle="tooltip"
        ...
        <!-- Settings (Mobile) -->
        <button class="mobile-settings-btn d-lg-none" data-bs-toggle="tooltip" data-bs-placement="bottom"
            title="Settings">
        ...
        <ul class="dropdown-menu dropdown-menu-end user-dropdown">
            ...
            <li>
                ...
                <a class="dropdown-item text-danger" href="#"
                    onclick="event.preventDefault(); document.getElementById('topbarLogoutForm').submit();">
